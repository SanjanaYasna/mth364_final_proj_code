...
#in terms of B* from different values of A
...
for kma in kma_values:
    ...
    for solution in unique_solutions:
        ...
        with open("NF1_kma.csv", "a") as f:
            ...
            trace = trace[0]
            det = det[0]    
            f.write(f"{kma},{A},{B},{trace},{det},{classification},{stable}\n")
        f.close()
        print(f"k_ma: {kma}, A: {A}, B: {B}, trace: {trace}, determinant: {det}, classification: {classification}, stable: {stable}")